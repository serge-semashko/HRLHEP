...
//                IOUtil.writeLogLn(0, "<span style='border:solid 1px green; font-weight:bold; background-color:#FFFFA0;'>REQUEST " 
//                    + rm.getString("queryLabel") + " (" + cfgTuner.getParameter("c") + ") DONE! (" + startTm + "ms)</span></div>", rm);
//        }
//        try {
//            Thread.sleep(5000);
