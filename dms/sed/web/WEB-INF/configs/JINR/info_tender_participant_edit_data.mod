...
Создание нового участника закупочного конкурса<BR>  ??cop=new
Добавление из справочника контрагентов<BR>  ??cop=add&REAL_ID_COUNT=0
...
window.parent.AjaxCall('d_spravCont', 'c=JINR/info_tender_participant&info_id=1014&requesterId=provider&multi=0&view=2&TABLE_NAME=i_jinr_tender_participant&irpp=30&START_REC=1');  ??!ERROR
